...
define( 'RPS_PAYPAL_VERSION', '1.3.2' );
...
function rps_myplugin_activate() {
	...
	if( !get_option('rps_myplugin_options') ) {
...
<!--
	<p><span>Product description (optional):</span></p>
		<textarea placeholder="An optional description of the item for sale" name="desc" id="desc" value=""><?php echo $name; ?></textarea>
